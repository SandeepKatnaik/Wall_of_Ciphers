...
public class InfoVig extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text = "Vigenere is polyalphabetic cipher.\n" +
                "Key size : Variable\n" +
                "It is stream cipher\n" +
                "For more details visit: http://surl.li/hgtoy";

        SpannableString spannableString = new SpannableString(text);

        // Find the start and end index of the link within the text
        int startIndex = text.indexOf("http://surl.li/hgtoy");
        int endIndex = startIndex + "http://surl.li/hgtoy".length();
